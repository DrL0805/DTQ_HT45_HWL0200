...
const uint8_t DotMatrix_E[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x20,0x23,0x20,0x18,0x00};
const uint8_t DotMatrix_F[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x00,0x03,0x00,0x00,0x00};
const uint8_t DotMatrix_G[] = {0xC0,0x30,0x08,0x08,0x08,0x38,0x00,0x00,0x07,0x18,0x20,0x20,0x22,0x1E,0x02,0x00};
const uint8_t DotMatrix_H[] = {0x08,0xF8,0x08,0x00,0x00,0x08,0xF8,0x08,0x20,0x3F,0x21,0x01,0x01,0x21,0x3F,0x20};
const uint8_t DotMatrix_I[] = {0x00,0x08,0x08,0xF8,0x08,0x08,0x00,0x00,0x00,0x20,0x20,0x3F,0x20,0x20,0x00,0x00};
const uint8_t DotMatrix_J[] = {0x00,0x00,0x08,0x08,0xF8,0x08,0x08,0x00,0xC0,0x80,0x80,0x80,0x7F,0x00,0x00,0x00};
const uint8_t DotMatrix_K[] = {0x08,0xF8,0x88,0xC0,0x28,0x18,0x08,0x00,0x20,0x3F,0x20,0x01,0x26,0x38,0x20,0x00};
const uint8_t DotMatrix_L[] = {0x08,0xF8,0x08,0x00,0x00,0x00,0x00,0x00,0x20,0x3F,0x20,0x20,0x20,0x20,0x30,0x00};
const uint8_t DotMatrix_M[] = {0x08,0xF8,0xF8,0x00,0xF8,0xF8,0x08,0x00,0x20,0x3F,0x00,0x3F,0x00,0x3F,0x20,0x00};
const uint8_t DotMatrix_N[] = {0x08,0xF8,0x30,0xC0,0x00,0x08,0xF8,0x08,0x20,0x3F,0x20,0x00,0x07,0x18,0x3F,0x00};
const uint8_t DotMatrix_O[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x20,0x23,0x20,0x18,0x00};
const uint8_t DotMatrix_P[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x20,0x23,0x20,0x18,0x00};
const uint8_t DotMatrix_Q[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x20,0x23,0x20,0x18,0x00};
const uint8_t DotMatrix_R[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x20,0x23,0x20,0x18,0x00};
const uint8_t DotMatrix_S[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x20,0x23,0x20,0x18,0x00};
const uint8_t DotMatrix_T[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x20,0x23,0x20,0x18,0x00};
const uint8_t DotMatrix_U[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x20,0x23,0x20,0x18,0x00};
const uint8_t DotMatrix_V[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x20,0x23,0x20,0x18,0x00};
const uint8_t DotMatrix_W[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x20,0x23,0x20,0x18,0x00};
const uint8_t DotMatrix_X[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x20,0x23,0x20,0x18,0x00};
const uint8_t DotMatrix_Y[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x20,0x23,0x20,0x18,0x00};
const uint8_t DotMatrix_Z[] = {0x08,0xF8,0x88,0x88,0xE8,0x08,0x10,0x00,0x20,0x3F,0x20,0x20,0x23,0x20,0x18,0x00};
		...
		case LCD_DRV_DOT_ASCII:	// ascii码		
			switch((uint8_t)DotCode)
			{
				...
				case ASCII_D:
					...
					break;
				case ASCII_E:
					memcpy(DotBuf, DotMatrix_E, 16);
					break;
				case ASCII_F:
					memcpy(DotBuf, DotMatrix_F, 16);
					break;
				case ASCII_G:
					memcpy(DotBuf, DotMatrix_G, 16);
					break;
				case ASCII_H:
					memcpy(DotBuf, DotMatrix_H, 16);
					break;
				case ASCII_I:
					memcpy(DotBuf, DotMatrix_I, 16);
					break;
				case ASCII_J:
					memcpy(DotBuf, DotMatrix_J, 16);
					break;
				case ASCII_K:
					memcpy(DotBuf, DotMatrix_K, 16);
					break;
				case ASCII_1:
